...
#color mapping palette for contours_30ft based on CONTOUR_FT
color4<-colorBin("GnBu",macleish_layers [["contours_30ft"]]$CONTOUR_FT)
...
map <- map %>%
#Add contour line
  addPolylines(data = macleish_layers[["contours_30ft"]], color = ~color4(CONTOUR_FT), group ="contour" ) %>%
  #adding Topography 
...
addLayersControl(
    ...
    overlayGroups = c("boundary", "buildings", "water_source", "forests","landmark","challenge_course","trail", "contour", "research", "New Campsites"),
...
```
^[https://github.com/JuliaClaireLee/mp3.git]

![This project was hard.](https://media.giphy.com/media/3o6ZtbdY6g0V8utOx2/giphy.gif)
