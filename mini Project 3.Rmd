...
#Add contour line
  ...
  addProviderTiles("CONTOUR_FT", group ="lines" ) %>%
  #Layers control
addLayersControl(
    baseGroups = c("lines"),
...
~point, ~lat, ~lon,
"camp_A",42.4465135346023, -72.6803904343483,
 "camp_B",42.4458189520893, -72.6787624426988,
"camp_C",42.45024,-72.68299,)
campsites<-st_as_sf(sites,coords = c("lon", "lat"), crs = 4326)
```
...
CAMP_B <- data.frame(lon = -72.6749333567048 , lat = 42.4458089520893) %>% 
 st_as_sf(coords = c("lon", "lat"), crs = 4326)
